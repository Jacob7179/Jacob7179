...
<!--   my-ticker -->    
[![Typing SVG](https://readme-typing-svg.herokuapp.com?color=%2336BCF7&center=true&vCenter=true&width=600&lines=Hi+there+👋,+I+am+Jacob7179;+Welcome+to+My+Profile!;Over+1+years+of+programming+experience;C,+HTML,+CSS,+JS,+PHP,+SQL,+Python+,Cpp;Always+learning+new+things+;Machine+learning+enthusiast)](https://git.io/typing-svg)
